...
var SpeedDial = _react.default.forwardRef(function SpeedDial(props, ref) {
  ...
  var eventTimer = _react.default.useRef();
  ...
  var nextItemArrowKey = _react.default.useRef();
  /**
  ...
  var allItems = _react.default.Children.toArray(childrenProp).filter(function (child) {
  ...
  return _react.default.createElement("div", (0, _extends2.default)({
    ...
    ref: handleFabRef
  }), _react.default.isValidElement(icon) && (0, _utils.isMuiElement)(icon, ['SpeedDialIcon']) ? _react.default.cloneElement(icon, {
    open: open
